...
@Component(
		immediate = true,
		property = {
			"commerce.product.content.renderer.key=" + ClassicElectricCPContentRenderer.KEY,
...
public class ClassicElectricCPContentRenderer implements CPContentRenderer {
	public static final String KEY = "Classic Electric Product";
	...
	public String getLabel(Locale locale) {
		return "Classic Electric Product Detail Renderer";
	}
